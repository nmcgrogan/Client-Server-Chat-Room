...
public class AsyncFileLoader {
    ...
    public static <T> void loadFileContent(String filePath, Class<T> cls, Supplier<T> emptyObjectSupplier, Consumer<T> callback) {
    ...
    public static void main(String[] args) {
        // Call the loadFileContent method with a file path, a class, an empty object supplier, and a callback
        loadFileContent("path/to/your/file", Project.common.Character.class, Project.common.Character::new, myObject -> {
